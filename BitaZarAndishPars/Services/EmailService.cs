...
namespace BitaZarAndishPars.Services
{
    /// <summary>
...
<head>
    <style>
        ...
        .field {{ margin: 10px 0; padding: 10px; background-color: white; border-right: 3px solid #4CAF50; }}
...
<body>
    <div class='container'>
        <div class='header'>
            <h2>فرم تماس وب‌سایت - پیام جدید</h2>
        </div>
        <div class='content'>
            <div class='field'>
        ...
        <div class='footer'>
            این پیام از طریق فرم تماس وب‌سایت بیتا زر اندیش پارس ارسال شده است.
        </div>
    </div>
</body>
</html>";
                ...
                {
                    From = new MailAddress(_emailSettings.FromEmail, "وب‌سایت بیتا زر اندیش پارس"),
