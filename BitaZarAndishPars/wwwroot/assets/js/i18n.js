...
(function () {
  ...
  const T = {
    ...
    fa: {
      ...
      /* FAQ items */
      'faq.q1' : 'چگونه سامانه‌های نرم‌افزاری توسعه می‌یابند؟',
      'faq.a1' : 'ما با استفاده از فناوری‌های پیشرفته و تیم متخصص، سامانه‌های نرم‌افزاری تحت وب را طراحی و توسعه می‌کنیم.',
      'faq.q2' : 'محصولات شما چه ویژگی‌هایی دارند؟',
      'faq.a2' : 'محصولات ما با تمرکز بر کارایی و امنیت، به بهبود فرآیندها در سازمان‌ها کمک می‌کنند.',
      'faq.q3' : 'چگونه می‌توانم با شما همکاری کنم؟',
      'faq.a3' : 'می‌توانید از طریق فرم تماس با ما ارتباط برقرار کنید یا با تیم تحقیقاتی ما همکاری کنید.',
      'faq.q4' : 'آیا محصولات شما با دانشگاه‌ها همکاری دارند؟',
      'faq.a4' : 'بله، ما با دانشگاه اصفهان در توسعه سامانه جامع پژوهشی و نرم‌افزارهای امنیتی همکاری داریم.',
      'faq.q5' : 'چگونه می‌توانم اطلاعات بیشتری درباره خدمات شما بگیرم؟',
      'faq.a5' : 'برای اطلاعات بیشتر می‌توانید با ما تماس بگیرید یا از طریق وب‌سایت ما اطلاعات لازم را دریافت کنید.',
    ...
    en: {
      ...
      /* FAQ items */
      'faq.q1' : 'How are software systems developed?',
      'faq.a1' : 'We design and develop web-based software systems using advanced technologies and a specialized team.',
      'faq.q2' : 'What features do your products have?',
      'faq.a2' : 'Our products focus on efficiency and security, helping organizations improve their processes.',
      'faq.q3' : 'How can I collaborate with you?',
      'faq.a3' : 'You can contact us via the contact form or collaborate with our research team.',
      'faq.q4' : 'Do your products collaborate with universities?',
      'faq.a4' : 'Yes, we collaborate with the University of Isfahan on developing the comprehensive research system and security software.',
      'faq.q5' : 'How can I get more information about your services?',
      'faq.a5' : 'For more information you can contact us or obtain the necessary information through our website.',
    ...
    ar: {
      ...
      /* FAQ items */
      'faq.q1' : 'كيف يتم تطوير أنظمة البرمجيات؟',
      'faq.a1' : 'نقوم بتصميم وتطوير أنظمة البرمجيات المبنية على الويب باستخدام تقنيات متقدمة وفريق متخصص.',
      'faq.q2' : 'ما هي مميزات منتجاتكم؟',
      'faq.a2' : 'تتميز منتجاتنا بالتركيز على الكفاءة والأمان، مما يساعد المنظمات على تحسين عملياتها.',
      'faq.q3' : 'كيف يمكنني التعاون معكم؟',
      'faq.a3' : 'يمكنك التواصل معنا عبر نموذج الاتصال أو التعاون مع فريقنا البحثي.',
      'faq.q4' : 'هل تتعاون منتجاتكم مع الجامعات؟',
      'faq.a4' : 'نعم، نتعاون مع جامعة أصفهان في تطوير نظام البحث الشامل وبرامج الأمن.',
      'faq.q5' : 'كيف يمكنني الحصول على مزيد من المعلومات حول خدماتكم؟',
      'faq.a5' : 'للمزيد من المعلومات يمكنك التواصل معنا أو الحصول على المعلومات اللازمة من خلال موقعنا.',
